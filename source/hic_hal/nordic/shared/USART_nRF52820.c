...
static int32_t USART_Uninitialize (void) {
  ...
  nrf_gpio_cfg_default(RTE_USART0_TX_PIN_NUM);
#endif
  ...
  nrf_gpio_cfg_default(RTE_USART0_RX_PIN_NUM);
#endif
  ...
  nrf_gpio_cfg_default(RTE_USART0_CTS_PIN_NUM);
#endif
  ...
  nrf_gpio_cfg_default(RTE_USART0_RTS_PIN_NUM);
#endif
...
static int32_t USART_Control (uint32_t control, uint32_t arg) {
  ...
  switch (control & ARM_USART_CONTROL_Msk) {
    case ARM_USART_MODE_ASYNCHRONOUS:
      ...
      switch (control & ARM_USART_FLOW_CONTROL_Msk) {
        case ARM_USART_FLOW_CONTROL_NONE:
          ...
          nrf_gpio_cfg_input(RTE_USART0_CTS_PIN_NUM, NRF_GPIO_PIN_NOPULL);
#endif
#if (RTE_USART0_RTS_EN != 0U)           /* If RTS Pin is enabled in config file */
          /* Disconnect RTS */
          NRF_UARTE0->PSEL.RTS = RTE_USART0_RTS_PIN_NUM | UARTE_PSEL_RTS_CONNECT_Msk;
          ...
          nrf_gpio_pin_set(RTE_USART0_RTS_PIN_NUM);
          nrf_gpio_cfg_output(RTE_USART0_RTS_PIN_NUM);
#endif
    ...
    case ARM_USART_CONTROL_TX:
	  ...
	  nrf_gpio_pin_set(RTE_USART0_TX_PIN_NUM);
	  nrf_gpio_cfg_output(RTE_USART0_TX_PIN_NUM);
          /* Connect TXD */
    ...
    case ARM_USART_CONTROL_RX:
      ...
      switch (arg) {
        ...
        case 1:                         /* Enable receiver */
          ...
          nrf_gpio_cfg_input(RTE_USART0_RX_PIN_NUM, NRF_GPIO_PIN_NOPULL);
          /* Connect RXD */
